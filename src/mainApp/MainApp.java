...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		tablero.setBackground(new java.awt.Color(165, 105, 189));
		...
		while (true) { // por siempre jamás (hasta que nos cierren la ventana) estamos controlando el
			...
			if (contador % 20 == 0) { // cada 200ms nos movemos o crecemos...
				...
				frame.comprobarEstado(tablero.getHeight(), tablero.getWidth()); // comprobamos si hemos muerto o no. Comentar esto para no morir
